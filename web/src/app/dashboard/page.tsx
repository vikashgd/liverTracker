...
export default async function DashboardPage() {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 border-t border-purple-200">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <UnifiedAIIntelligenceDashboard charts={charts} />
        </div>
      </div>

      {/* Auto-Calculated Medical Scores */}
      ...
      <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-t border-teal-200">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <EnhancedImagingDashboard userId={userId} />
        </div>
      </div>
